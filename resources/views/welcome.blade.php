...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div style="border:1px #0f6674 solid;background-color:#0f6674;padding-left:10px;border-bottom:2px white solid;">
            <h1 style="color:white;">Liste de cours</h1>
        </div>
        <div id="container" class="relative flex flex-row items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0" style="gap:20px;flex-wrap:wrap;">
        ...
        <script>
            ...
            async function renderCours() {
                ...
                cours.forEach(cour => {
                    /*let htmlSegment =
                        `<div class="cour">
                            <img src="${cour.image_url}" >
                            <h2>${cour.nom} ${cour.description}</h2>
                        </div>`;*/

                    let htmlSegment =
                        `<div class="card">
                            <div class="card-img">
                                <img style="width:100%;" src="${cour.image_url}">
                            </div>
